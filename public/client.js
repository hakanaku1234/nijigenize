...
},{"./components/Container":162,"react":158,"react-dom":2}],161:[function(require,module,exports){
"use strict";
...
},{"../Observer":159,"./AssetsLoader":161,"./Controller":163,"./FaceTracker":164,"./Live2DCanvas":165,"./UserMedia":166,"react":158}],163:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"../workers/calculateWorker":167,"react":158}],165:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
function calculateWorker() {
    var BLINK_JUDGEMENT_THRESHOLD = 0.04;
    function getDistance2(position, a, b) {
        return Math.pow(position[a][0] - position[b][0], 2) + Math.pow(position[a][1] - position[b][1], 2);
    }
    function isAboveAB(position, a, b, target) {
        return (position[b][1] - position[target][1]) / (position[target][0] - position[b][0]) > (position[b][1] - position[a][1]) / (position[a][0] - position[b][0]);
    }
    function getRelativeEyeH(position, eye, fromEdge, toEdge) {
        var edgeDistance2 = getDistance2(position, fromEdge, toEdge), eyeFromEdge2 = getDistance2(position, fromEdge, eye), eyeToEdge2 = getDistance2(position, eye, toEdge);
    ...
    self.onmessage = function (event) {
        var _a = event.data, position = _a.position, probableBlinkHeight = _a.probableBlinkHeight, probableBlinkDiff = _a.probableBlinkDiff;
        if (!position) {
            return;
        }
        var parameter = {}, faceR = position[37][0] - position[2][0], faceL = position[12][0] - position[37][0], mouthH = position[57][1] - position[60][1], lipH = position[53][1] - position[57][1], eyeH = position[26][1] - position[24][1], relativeEyeHL = getRelativeEyeH(position, 27, 0, 33), relativeEyeHR = getRelativeEyeH(position, 32, 33, 14);
        var newProbableNoBlinkHeight = null, newProbableBlinkHeight = null;
        // eye open
        ...
        self.postMessage({ parameter: parameter, probableNoBlinkHeight: newProbableNoBlinkHeight, probableBlinkHeight: newProbableBlinkHeight });
    };
}
Object.defineProperty(exports, "__esModule", { value: true });
exports.default = calculateWorker;
